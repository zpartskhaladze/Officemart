...
public class AddressBordersTest extends ChromeRunner {
    ...
    @Description("Test case N#30")
    public void addressBordersChange() {
        ...
        formSectionSteps.clickLegalSend()
                ...
                .enterAddress(pageData.address)
                .clickLegalSend()
                .checkAddressFieldBorderNotRed();
    }
}
