...
public class EmailBordersTest extends ChromeRunner {
    ...
    @Description("Test case N#37")
    public void emailBordersChange() {
        ...
        formSectionSteps.clickLegalSend()
                ...
                .enterRegularEmail(pageData.regularEmail)
                .clickLegalSend()
                .checkEmailFieldBorderNotRed();
    }
