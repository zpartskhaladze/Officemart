...
public class LongIdentifierTest extends ChromeRunner {
    ...
    @Description("Test case N#28")
    public void longIdentifierCode() {
        ...
        cartSteps.addToCart()
                .openCart()
                .clickContinueCart();
        formSectionSteps.enterLongCode(pageData.longCode);
    }
}
