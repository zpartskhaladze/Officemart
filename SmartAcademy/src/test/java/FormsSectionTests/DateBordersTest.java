...
public class DateBordersTest extends ChromeRunner {
    ...
    @Description("Test case N#36")
    public void dateBordersChange() {
        ...
        formSectionSteps.clickLegalSend()
                ...
                .enterRegularDate(pageData.regularDate)
                .clickLegalSend()
                .checkDateFieldBorderNotRed();
    }
}
