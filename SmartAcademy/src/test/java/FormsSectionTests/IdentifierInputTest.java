...
public class IdentifierInputTest extends ChromeRunner {
    ...
    @Description("Test case N#26")
    public void IdentificationInput() {
        ...
        cartSteps.addToCart()
                .openCart()
                .clickContinueCart();
        formSectionSteps.VerifyIdentifiernput(pageData.companyName);
